...
export const metadata: Metadata = {
  title: "Next.js Avatars | Smartmeet Uzbekistan - Next.js Dashboard Template",
  description:
    "This is Next.js Avatars page for Smartmeet Uzbekistan - Next.js Tailwind CSS Admin Dashboard Template",
};
