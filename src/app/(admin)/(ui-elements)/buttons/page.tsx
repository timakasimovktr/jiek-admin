...
export const metadata: Metadata = {
  title: "Next.js Buttons | Smartmeet Uzbekistan - Next.js Dashboard Template",
  description:
    "This is Next.js Buttons page for Smartmeet Uzbekistan - Next.js Tailwind CSS Admin Dashboard Template",
};
