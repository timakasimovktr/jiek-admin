...
export const metadata: Metadata = {
  title: "Next.js Modals | Smartmeet Uzbekistan - Next.js Dashboard Template",
  description:
    "This is Next.js Modals page for Smartmeet Uzbekistan - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
